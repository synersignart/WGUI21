...
namespace MultiWiiWinGUI
{
    ...
    public class GUI_settings
    {
        ...
        public void save_to_xml(string filename)
        {
            ...
            tw.WriteStartElement("LOGEXL value=\"" + logGexl + "\""); tw.WriteEndElement();
                ...
                while (reader.Read())
                {
                    switch (reader.NodeType)
                    {
                        case XmlNodeType.Element:
                            ...
                            if (String.Compare(reader.Name, "logexl", true) == 0 && reader.HasAttributes) { logGexl = Convert.ToBoolean(reader.GetAttribute("value")); }
