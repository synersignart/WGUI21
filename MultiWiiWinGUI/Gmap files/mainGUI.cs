...
namespace MultiWiiWinGUI
{
    ...
    public partial class mainGUI : Form
    {
        ...
        const string sVersion = "231";
        byte byteVersion = 231;
        ...
        static PointLatLng copterPos = new PointLatLng(0.402489, 0.071558);       //Just the corrds of my flying place
        ...
        public mainGUI()
        {
            ...
            mapProviders[2] = GMapProviders.WikiMapiaMap;
            mapProviders[3] = GMapProviders.GoogleKoreaSatelliteMap;
            mapProviders[4] = GMapProviders.GoogleSatelliteMap;
            mapProviders[5] = GMapProviders.GoogleMap;
            //mapProviders[5] = GMapProviders.ArcGIS_World_Topo_Map;
            //mapProviders[3] = GMapProviders.GoogleChinaSatelliteMap;
        ...
        private void mainGUI_Load(object sender, EventArgs e)
        {
            ...
            cb_Log11.Checked = gui_settings.logGexl;
            ...
            if (gui_settings.speech_enabled)
            {
                ...
                speech.Rate = -1;
                speech.SpeakAsync("Initialisation completed. Vehicle Reporting!");
            }
...
#region extended_aux_states
        ...
        private void update_gui()
        {
                ...
                if ((prev_state != mw_gui.nav_state) || (prev_wp != mw_gui.wp_number))
                {
                    switch (mw_gui.nav_state)
                    {
                        ...
                        case 4: speech.SpeakAsync("Timed position hold.");
                            break;
                        case 5: speech.SpeakAsync("Navigating to " + mw_gui.wp_number.ToString() + ".");
                            break;
                        case 9: speech.SpeakAsync("Landing is in progress.");
                            break;
                        case 10: speech.SpeakAsync("Aircaft Has landed.");
                            break;
            ...
            if (tabMain.SelectedIndex == GUIPages.Mission)
            {
                ...
                if (bShowGauges)
                {
                    ...
                    attitudeIndicatorInstrumentControl2.SetArtificalHorizon(-mw_gui.angy, -mw_gui.angx);
        ...
        private void log_option_Clicked(object sender, EventArgs e)
        {
            ...
            gui_settings.logGexl = cb_Log11.Checked;
            b_save_gui_settings.BackColor = Color.LightCoral;
        }
        ...
        void openLog()
        {
            ...
            {
                bLogRunning = true;
                wLogStream.WriteLine("FlyWii telemetry log. Start time:{0}", DateTime.Now.ToString("yyyy/MM/dd HH:mm:ss.fff"));
            }
        ...
        void updateLog()                //Update log with the neccessary entries, caller must check if log is open and enabled
        {
            ...
            // Nav-GPS
            if (gui_settings.logGnav) { wLogStream.WriteLine("GNAV,{0},{1},{2},{3},{4},{5},{6}", DateTime.Now.ToString("HH:mm:ss.fff"), mw_gui.GPS_fix, mw_gui.GPS_numSat, mw_gui.GPS_directionToHome, mw_gui.GPS_distanceToHome, mw_gui.GPS_longitude, mw_gui.GPS_latitude); }
            // Housekeeping
            ...
            //Excel Log
            if (gui_settings.logGexl) { wLogStream.WriteLine("GEXL,{0},{1},{2},{3},{4},{5},{6},{7},{8}", DateTime.Now.ToString("HH:mm:ss.fff"), mw_gui.rcAUX[0], mw_gui.rcAUX[1], mw_gui.rcAUX[2], mw_gui.rcAUX[3], mw_gui.vBat, mw_gui.EstAlt, mw_gui.GPS_longitude, mw_gui.GPS_latitude); }
        ...
        void addKMLMarker(string description, double lon, double lat, double alt)
        {
            ...
            wKMLLogStream.WriteLine("<altitudeMode>absolute</altitudeMode>");
            wKMLLogStream.WriteLine("<coordinates>");
            wKMLLogStream.WriteLine("{0},{1},{2},{3}", (decimal)lon / 10000000, (decimal)lat / 10000000, alt);
            wKMLLogStream.WriteLine("</coordinates>");
            wKMLLogStream.WriteLine("</Point>");
            wKMLLogStream.WriteLine("</Placemark>");
        ...
        public void save_mission(string filename)
        {
            ...
            tw.WriteComment(String.Format("{0}, Version {0}", assemName.Name, ver.ToString()));
        ...
        private void cbShowGauges_CheckedChanged(object sender, EventArgs e)
        {
            if (bShowGauges)
            {
                ...
                attitudeIndicatorInstrumentControl2.Visible = false;
            ...
            else
            {
                ...
                attitudeIndicatorInstrumentControl2.Visible = true;
                if (indicators_mission != null)
        ...
        private void motorsIndicator1_Click(object sender, EventArgs e)
        {
        ...
        private void altitude_meter2_Click(object sender, EventArgs e)
        {

        }

        private void battery_indicator2_Click(object sender, EventArgs e)
        {
        ...
        private void altitude_meter1_Click(object sender, EventArgs e)
        {

        }

        private void cb_Log8_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void cb_Log10_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void cb_Log11_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void headingIndicatorInstrumentControl1_Click(object sender, EventArgs e)
        {
